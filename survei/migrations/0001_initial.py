    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ruang_lingkup', models.CharField(choices=[('Nasional', 'Nasional'), ('Kota', 'Kota'), ('Provinsi', 'Provinsi')], default='Nasional', max_length=255)),
                ('wilayah_survei', models.CharField(default='')),
                ('jumlah_responden', models.IntegerField(default=0)),
                ('tipe_survei', models.CharField(choices=[('Digital', 'Digital'), ('Lainnya', 'Lainnya'), ('Paper-based', 'Paper-based')], default='Paper-based', max_length=255)),
